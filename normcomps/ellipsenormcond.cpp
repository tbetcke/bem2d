...
int main(int argc, char** argv)
{
  ...
  std::string filename="ellipsenormcond10.txt";
  ...
  std::vector<double> cond_combined2(freqs.size());
	...
	double eta2=cbrt(k.re*k.re);
        bem2d::pCurve eobj(new bem2d::Ellipse(2));
	int n=(int)(eobj->Length()*k.re*ppw/2.0/bem2d::PI);
        bem2d::AnalyticCurve ellipse(n,eobj);
        bem2d::pGeometry pgeom=ellipse.GetGeometry();
