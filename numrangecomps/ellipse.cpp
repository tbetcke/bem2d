...
int main(int argc, char** argv)
{
  ...
  std::string file="/home/tbetcke/svn/numerical_coercivity/data/ellipse";
  ...
  //freqs.push_back(200);
	...
	double eta1=k.re; // Coupling between conj. double and single layer pot.
        bem2d::pCurve cobj(new bem2d::Ellipse(ellipseparam));
	...
	bem2d::WriteDomain("/home/tbetcke/svn/numerical_coercivity/data/ellipse_shape",pgeom,5);
