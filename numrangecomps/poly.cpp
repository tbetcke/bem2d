...
int main(int argc, char** argv)
{
  ...
  std::string file="/home/tbetcke/svn/numerical_coercivity/data/poly";
  ...
  //freqs.push_back(500);
        ...
        std::vector<bem2d::Point> nonconvexpoly;
        nonconvexpoly.push_back(bem2d::Point(0,0));
	nonconvexpoly.push_back(bem2d::Point(2,0));
	nonconvexpoly.push_back(bem2d::Point(2,-1));
	nonconvexpoly.push_back(bem2d::Point(3,-1));
	nonconvexpoly.push_back(bem2d::Point(3,1));
	nonconvexpoly.push_back(bem2d::Point(1,1));
	nonconvexpoly.push_back(bem2d::Point(1,2));
	nonconvexpoly.push_back(bem2d::Point(0,2));
	...
	bem2d::Polygon poly(nonconvexpoly,ppw,k,10,0.15);
        bem2d::pGeometry pgeom=poly.GetGeometry();
	bem2d::WriteDomain("/home/tbetcke/svn/numerical_coercivity/data/poly_shape",pgeom,5);
