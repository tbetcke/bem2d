...
int main(int argc, char** argv)
{
  ...
  std::string file="/home/tbetcke/svn/numerical_coercivity/data/kite";
  ...
  //freqs.push_back(200);
	...
	int n=(int)(cobj->Length()*k.re*ppw/2.0/bem2d::PI);
        bem2d::AnalyticCurve kite(n,cobj);
        bem2d::pGeometry pgeom=kite.GetGeometry();
	bem2d::WriteDomain("/home/tbetcke/svn/numerical_coercivity/data/kite_shape",pgeom,5);
